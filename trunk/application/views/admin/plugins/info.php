    ...
    <div class="full">
        <div class="box">
            ...
            <div class="content forms">
                ...
                <?php } ?>
                <?php echo form_open_multipart('admin/plugins/info', 'id="add_forms"'); ?>
                <div class="line">
                    <?php
                ...
                <div class="line">
					...
					<a href="<?php echo site_url("admin/plugins/index");?>" class="button grey medium" style="margin-bottom: 0px;">
