    ...
    <div class="full">
        <div class="box">
            ...
            <div class="content forms" style="line-height:30px;">
                <?php echo form_open_multipart('admin/ad/search', 'method="get" id="admin_user_search_forms"'); ?>
                <div class="line form">
        ...
        <div class="box" style="border: 0px;">
            <a class="button green big" href="<?php echo site_url("admin/ad/info/0")?>" style="opacity: 1;"><?php echo $this->lang->line("add");?></a>
        </div>
        <div class="box">
            <div class="contents">
                <table cellspacing="0" cellpadding="0" border="0" class="sorting">
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="button blue medium" href="<?php echo site_url("admin/ad/info/".$val['cat_id']);?>" style="opacity: 1;"><?php echo $this->lang->line("edit");?></a>
                            <a class="button grey medium" href="<?php echo site_url("admin/ad/del/".$val['cat_id']);?>" style="opacity: 1;" onclick="if (!confirm('<?php echo $this->lang->line("confirm_del");?>')) return false;"><?php echo $this->lang->line("del");?></a>
                        </td>
                    </tr>
                        <?php } ?>
                    </tbody>
