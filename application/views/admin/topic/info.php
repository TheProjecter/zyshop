...
<div class="section">
    <div class="full">
        <div class="box">
            <div class="title">
                <h2><?php echo $this->lang->line('category_form');?></h2>
            </div>
            <div class="content forms">
                ...
                <?php } ?>
                <?php echo form_open_multipart('admin/category/info', 'id="add_category_forms"'); ?>
                <div class="line">
                    <?php
                ...
                <div class="line">
					...
					<a href="<?php echo site_url("admin/category/index");?>" class="button grey medium" style="margin-bottom: 0px;">
