    ...
    <div class="full">
        <div class="box">
            ...
            <div class="content forms" style="line-height:30px;">
                ...
                <?php echo form_open_multipart('admin/users/search', 'method="get" id="admin_user_search_forms"'); ?>
                <div class="line form">
        ...
        <div class="box" style="border: 0px;">
            <a class="button green big" href="<?php echo site_url("admin/users/info/0")?>" style="opacity: 1;"><?php echo $this->lang->line("add");?></a>
        </div>
        <div class="box">
            <div class="contents">
